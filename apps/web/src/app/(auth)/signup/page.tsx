  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black ">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="bg-gradient-to-r from-transparent via-neutral-300 -700 to-transparent my-8 h-[1px] w-full" />

        <div className="flex flex-col space-y-4">
          <button
            className=" relative group/btn flex space-x-2 items-center justify-start px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-gray-50 -900 0px_0px_1px_1px_var(--neutral-800)]"
            type="submit"
          >
            <IconBrandGithub className="h-4 w-4 text-neutral-800 -300" />
            <span className="text-neutral-700 -300 text-sm">
              GitHub
            </span>
            <BottomGradient />
          </button>
          <button
            ...
            type="submit"
          >
            <IconBrandGoogle className="h-4 w-4 text-neutral-800 -300" />
            <span className="text-neutral-700 -300 text-sm">
              Google
            </span>
            <BottomGradient />
